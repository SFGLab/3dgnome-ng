...
| `weight_arcs` | float | 0.0 | 10.0 | The arcs stage's own confinement weight. 0 uses `weight`. A chromosome sized solve needs a stronger sphere than a block's chain. |
