...
| 2 | Contact frequency instead of mean distance | A loop is on in some conformations and off in others and the mean blurs it. P(d < r) over the ensemble for the nearest enhancer and inside idea 1. Ten conformations is thin for it; the genome arms give more. | open, first look 2026-09-20 | From the same run, the fraction of conformations with the nearest enhancer under 2 or 3 units correlates at 0.28 to 0.35 against 0.34 to 0.40 for the mean distance, and the summed contact frequency over enhancers at 0.26 to 0.32. At ten conformations the fraction takes eleven values, which caps a rank correlation, so this is not settled until the genome arms give more conformations. |
