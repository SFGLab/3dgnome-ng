...
HEADER = """\
# {cell} ensemble: arc-gap blocks, CTCF anchors, {singletons} singletons, distance map, dynamic
# subanchors,
...
def main() -> None:
    ...
    for cell in CELLS:
        cfg = build(cell, args.singletons, args.ev_weight, args.ib_arcs)
        ...
        path = out_dir / f"{cell.lower()}_{args.singletons}_arcs{tag}.ini"
