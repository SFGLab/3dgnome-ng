...
def build(
    ...
    if ib_arcs is not None:
        # IB placement otherwise discards every arc crossing a block boundary, so blocks joined
        # by many loops are placed no closer than blocks joined by none.
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        default=None,
        metavar="WEIGHT",
        help="enable cross-block arc targets in IB placement at this weight",
    )
    args = ap.parse_args()
